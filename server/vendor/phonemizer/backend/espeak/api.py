...
class EspeakAPI:
    ...
    def _shared_library_path(library) -> Path:
        ...
        try:
            ...
            raise RuntimeError(f"failed to retrieve the path to {library} library") from None
    ...
    def text_to_phonemes(self, text_ptr, text_mode, phonemes_mode):
        ...
        f_text_to_phonemes.argtypes = [ctypes.POINTER(ctypes.c_char_p), ctypes.c_int, ctypes.c_int]
